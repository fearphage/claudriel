...
namespace Claudriel\Support\Provenance;
 ...
 *
 * Duplicated from waaseyaa/cli until the split package ships this namespace; then prefer
 * {@see \Waaseyaa\CLI\Provenance\ComposerProvenanceReporter} and delete this tree.
 */
